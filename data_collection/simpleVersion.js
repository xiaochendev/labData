...
console.log(`1. After removed last element, current data is:`);
console.log(shallowCopyData);
...
console.log(`2. Inserted new object at index 1, current data is:`)
console.log(shallowCopyData);
...
console.log(`3. Add the object to the end of the array, current data is:`)
console.log(shallowCopyData);



console.log(`
------ Part 5 Full Circle: jsonToGridArray and GridArrayToCsv`);

...
//  @route: GET /api/grades/:id/learner
//  @desc: Get Grades by learner ID
//  @access: Public
router
  .route("/:id/learner")
  .get(gradeCTRL.getByLearnerId)
  .delete(gradeCTRL.deleteLearner);
...
//  @route: GET /api/grades/:classId/class/:learnerId/learner
//  @desc: Get Grades by class & learner ID
//  @access: Public
router
  .route("/:classId/class/:learnerId/learner")
  .get(gradeCTRL.getByLearnerClass);
